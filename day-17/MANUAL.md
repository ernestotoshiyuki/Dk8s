...
### instalando o calico
  kind create cluster --config cluster-kind.yaml --name calico
  kubectl get nodes -o wide

Instalando o calico de acordo com a documentação oficial
  kubectl apply -f https://raw.githubusercontent.com/projectcalico/calico/v3.31.4/manifests/calico.yaml

verficando a instalacao 
...
spec:
  ...
  - from:
    - podSelector:
        matchLabels:
          app: giropops-senhas  # pod de origem
      namespaceSelector:
        matchLabels:
          kubernetes.io/metadata.name: giropops
    ports:
