...
Para esse exemplo, vamos criar um arquivo chamado storageclass-nfs.yaml e adicionar o seguinte conteúdo. #(eu utilizei o existente giropops)
```yaml
...
spec: # especificação do PVC
  ...
  selector: # seletor de labels
    matchLabels: # labels que serão utilizadas para selecionar o PV
      storage: nfs # label que será utilizada para selecionar o PV (meu lab esta com giropops
``` 
